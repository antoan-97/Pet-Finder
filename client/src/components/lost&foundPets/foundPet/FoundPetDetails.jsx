...
import useFoundPetDetails from '../../../hooks/foundPets/useFoundPetDetails';
            ...
            <div className="max-w-4xl mx-auto rounded-xl shadow-2xl overflow-hidden">
                <div className="p-8">
                    <h2 className="text-3xl font-bold text-black mb-6 border-b pb-4">
                        {t('foundPetsCard.breed')} - {pet.breed}
                    </h2>
                    ...
                    <div className="space-y-4">
                        <p className="text-xl">
                            <strong className="text-black">{t('foundPetsCard.location')}:</strong> {pet.location}
                        </p>
                        <p className="text-xl">
                            <strong className="text-black">{t('foundPetsCard.description')}:</strong> {pet.description}
                        </p>
                        <p className="text-xl">
                            <strong className="text-black">{t('foundPetsCard.contact')}:</strong> {pet.phone}
                        </p>
                    </div>
