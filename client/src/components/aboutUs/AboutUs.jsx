        ...
        <section className="bg-green-500 py-12">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Link to='/' className="bg-pink-100 rounded-lg shadow-md p-4 overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
                        <img
                ...
                <div className="text-center mt-10">
                    <Link to='/donate'
                        className="inline-block px-6 py-3 text-white bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg shadow-lg hover:from-blue-600 hover:to-blue-800 transition duration-300 ease-in-out transform hover:scale-105"
                        >
