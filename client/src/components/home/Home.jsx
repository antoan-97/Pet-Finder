                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center">Lost Pets</h3>
                        ...
                        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center">Found Pets</h3>
                            <p className="text-gray-600 mb-4 text-sm sm:text-base text-center">
                        ...
                        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center">Pet Adoption</h3>
                            <p className="text-gray-600 mb-4 text-sm sm:text-base text-center">
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
                        <div>
                            ...
                            <p className="text-sm sm:text-base">Pets Found</p>
                        </div>
                        <div>
                            <h3 className="text-2xl sm:text-4xl font-bold mb-2">300+</h3>
                            <p className="text-sm sm:text-base">Happy Adoptions</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:text-base">Partner Shelters</p>
                        </div>
                    </div>
                </div>
            </section>
